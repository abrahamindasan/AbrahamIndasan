        ...
        <div class="container container-header">
            <div class="nav-sign">
                ...
                <ul class = "navbar h-text navbar-collapse" >
                    ...
                    <li class = "nav-item"><a class = "nav-link <?php echo $features; ?>" href="../end-users/features.php">FEATURES</a></li>
                    <li class = "nav-item"><a class = "nav-link <?php echo $tutors; ?>" href="../end-users/tutors.php">TUTORS</a></li>
                    <li  id = "about-link" class = "nav-item" ><a  class = "nav-link <?php echo $about; ?>" href="#about">ABOUT US</a></li>
